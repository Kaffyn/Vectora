          ...
          <div onClick={(e) => e.stopPropagation()}>
            <McpToolRow
              tool={{
                ...
                alwaysAllow: server?.tools?.find((tool) => tool.name === useMcpServer.toolName)?.alwaysAllow || false,
              }}
...
const ResponseContainerInternal = ({
  ...
  return (
    ...
    >
      {isJson ? <CodeBlock source={response} language="json" /> : <Markdown markdown={response} partial={isPartial} />}
    </div>
  );
};

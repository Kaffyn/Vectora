      ...
      >
        <div className="flex flex-col w-full">
          ...
          <div className="px-3 pb-4">
            ...
            <p className="m-0 text-xs text-vscode-descriptionForeground">{t("worktrees:selector.description")}</p>
          </div>
                ...
                >
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-bold truncate">{worktree.branch || t("worktrees:noBranch")}</span>
                      {worktree.isBare && <span className="text-xs opacity-70">{t("worktrees:primary")}</span>}
                    </div>
                    <div className="text-xs text-vscode-descriptionForeground ml-5 truncate">{worktree.path}</div>
                  </div>

      ...
      <Section>
        ...
        {mcpEnabled && (
          <>
            ...
            >
              <VSCodeLink
                href={buildDocLink("features/mcp/using-mcp-in-roo#editing-mcp-settings-files", "mcp_edit_settings")}
                style={{ display: "inline" }}
              >
    ...
    <div style={{ marginBottom: "10px" }}>
      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", marginRight: "8px" }} onClick={(e) => e.stopPropagation()}>
          <Button variant="ghost" size="icon" onClick={() => setShowDeleteConfirm(true)} style={{ marginRight: "8px" }}>
                ...
                {server.instructions && (
                  <VSCodePanelView id="instructions-view">
                    <div style={{ padding: "10px 0", fontSize: "12px" }}>
                      <div className="opacity-80 whitespace-pre-wrap break-words">{server.instructions}</div>
                    </div>
                  </VSCodePanelView>
                )}
      ...
      <Dialog open={showDeleteConfirm} onOpenChange={setShowDeleteConfirm}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>{t("mcp:deleteDialog.description", { serverName: server.name })}</DialogDescription>
          </DialogHeader>
          <DialogFooter>

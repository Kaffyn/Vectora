        ...
        <div className="flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-1">
            <Textarea
              ...
              rows={5}
            />
            {descriptionError && <span className="text-xs text-vscode-errorForeground">{t(descriptionError)}</span>}
          </div>
          ...
          <div className="flex flex-col gap-1">
            ...
            <Select value={source} onValueChange={(value) => setSource(value as "global" | "project")}>
              ...
              <SelectContent>
                ...
                {hasWorkspace && <SelectItem value="project">{t("settings:skills.source.project")}</SelectItem>}
              </SelectContent>
            </Select>
          </div>

...
export const ImageGenerationSettings = ({
  ...
  const currentProvider = getImageGenerationProvider(imageGenerationProvider, !!openRouterImageGenerationSelectedModel);
  ...
  const handleProviderChange = (value: string) => {
    ...
    if (providerModels.length > 0) {
      ...
      const currentModelForNewProvider = providerModels.find((m) => m.value === openRouterImageGenerationSelectedModel);

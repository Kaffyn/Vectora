          ...
          <div className="flex flex-col gap-3 pl-3 border-l-2 border-vscode-button-background">
            ...
            >
              <VSCodeCheckbox
                ...
                onChange={(e: any) => setCachedStateField("alwaysAllowWriteOutsideWorkspace", e.target.checked)}
            ...
            >
              <VSCodeCheckbox
                ...
                onChange={(e: any) => setCachedStateField("alwaysAllowWriteProtected", e.target.checked)}

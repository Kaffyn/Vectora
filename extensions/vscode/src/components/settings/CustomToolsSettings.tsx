      ...
      {enabled && (
        <div className="ml-2 space-y-3">
          <div className="flex items-center justify-between gap-4">
            <label className="block font-medium">{t("settings:experimental.CUSTOM_TOOLS.toolsHeader")}</label>
                  ...
                  <div className="space-y-1">
                    ...
                    <div>
                      {tool.parameters.map((param) => (
                        ...
                        >
                          <code className="text-vscode-textLink-foreground font-mono">{param.name}</code>
                          <span className="text-vscode-descriptionForeground">({param.type})</span>
                          {param.required && (
                            <span className="text-vscode-errorForeground text-[10px] uppercase">required</span>
                          )}
                          {param.description && (
                            <span className="text-vscode-descriptionForeground">— {param.description}</span>
                          )}
                        </div>
                      ))}
                    </div>

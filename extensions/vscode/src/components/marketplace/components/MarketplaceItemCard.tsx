        ...
        <div className="flex gap-2 items-start justify-between">
          ...
          <div className="flex items-center gap-1">
            {isInstalled ? (
              ...
              <Button size="sm" variant="primary" className="text-xs h-5 py-0 px-2" onClick={handleInstallClick}>
            ...
            <AlertDialogDescription>
              {item.type === "mode" ? (
                <>
                  ...
                  <div className="mt-2 text-sm">{t("marketplace:removeConfirm.mode.rulesWarning")}</div>
                </>
              ) : (

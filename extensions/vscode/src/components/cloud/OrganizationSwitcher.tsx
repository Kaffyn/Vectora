        ...
        <SelectTrigger className="w-full">
          <SelectValue>
            <div className="flex items-center gap-2">
              {selectedOrgId ? (
                <>
                  {organizations.find((org) => org.organization.id === selectedOrgId)?.organization.image_url ? (
                    <img
                      src={organizations.find((org) => org.organization.id === selectedOrgId)?.organization.image_url}
                      alt=""
                  ...
                  <span className="truncate">
                    {organizations.find((org) => org.organization.id === selectedOrgId)?.organization.name}
                  </span>
                </>
              ) : (
                <>

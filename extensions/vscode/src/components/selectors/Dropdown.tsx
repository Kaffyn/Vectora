...
export const DropdownItem: React.FC<{
    ...
    <div 
        ...
        className={cn(
            ...
            active ? "bg-vscode-button-background text-vscode-button-foreground" : "hover:bg-vscode-toolbar-hoverBackground text-vscode-descriptionForeground hover:text-vscode-editor-foreground",
            className
        )}
    >
        {children}

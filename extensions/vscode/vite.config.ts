...
export default defineConfig({
  ...
  resolve: {
    alias: [
      { find: '@core/prompts/sections/custom-instructions', replacement: resolve(__dirname, './src/core/prompts/sections/custom-instructions.browser.ts') },
      ...
      { find: '@services/search/file-search', replacement: resolve(__dirname, './src/services/search/file-search.browser.ts') },
